...
//                                                             child: RichText(
//                                                               text: TextSpan(
//                                                                 text: "Submitted By:", style: GoogleFonts.roboto(
//                                                                     fontWeight: FontWeight.w700,
//                                                                     color: Colors.black),
//                                                                 children: [
//                                                                   TextSpan(text: "${svFormOneController.svsiteList?.value[i].sites[0].reportSubmit?.fullName}",
//                                                                       style: GoogleFonts.roboto(fontWeight: FontWeight.w500, color: Colors.black)),
//                                                                 ],
//                                                               ),
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: Text(
                                                  // "${svFormOneController.svsiteList.value[i].sites[0].siteName}",
                                                  svFormOneController.svsiteList?.value[i].sites[0].siteName ?? "No Data",
                                                  style: const TextStyle(fontSize: 18),
                                                ),
                                              ),
                                              Row(
                                                    ...
                                                    child: RichText(
                                                      text: TextSpan(
                                                        ...
                                                        children: [
                                                          ...
                                                          svFormOneController.svsiteList?.value[i].sites[0].reportSubmit?.fullName ??"No Data",
                                                              style: GoogleFonts.roboto(fontWeight: FontWeight.w500, color: Colors.black)),
                                                        ],
                                                      ),
                                                      overflow: TextOverflow.ellipsis,
                                            ...
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                          ...
                                                          style: AppConstant.getRoboto(
                                                              FontWeight.w800,
                                                              AppConstant.HEADLINE_SIZE_22, Colors.black),
                                                          maxLines: 1,
                                                          overflow:
                                                          TextOverflow
                                                              .ellipsis,
                                                        ...
                                                        Visibility(
                                                          visible: dashboardController.user_role == "super_engineer" ? false : true,
                                                          child:
                                                          Bounceable(
                                                            onTap: () {
                                                              dashboardController.currentSiteID?.value = svFormOneController.svsiteList.value[i].sites[0].id;
                                                              dashboardController.currentSiteID!.refresh();Get.to(
                                                                      () => Take_Selfie(),
                                                                  curve: Curves.fastOutSlowIn,
                                                                  duration: Duration(milliseconds: 1000));
                                                            },
                                                  ...
                                                  Text(
                                                    "${svFormOneController.svsiteList.value[i].sites[0].startDate}",
                                                    style: AppConstant.getRoboto(FontWeight.w500,
                                                        AppConstant.HEADLINE_SIZE_20,
                                                        Color(0xff53C17F)),
                                                  )
                                                ],
                                                    ...
                                                    return Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                          "Submitted By:",
                                                          style: AppConstant.getRoboto(
                                                            FontWeight.w500, AppConstant.HEADLINE_SIZE_20,
                                                            const Color(
                                                                0xff33272A),
                                                          ),
                                                        ),
                                                    ...
                                                    children: [
                                                      Text(
                                                        ...
                                                        style: AppConstant.getRoboto(
                                                          FontWeight.w500,
                                                          AppConstant.HEADLINE_SIZE_20,
                                                          const Color(0xff33272A),
                                                        ),
                                                      ),
                                                      Text(
                                                        userData['full_name'] ?? "Wanting.",
                                                        maxLines: 1,
                                                        overflow:
                                                        TextOverflow
                                                            .ellipsis,
                                              ...
                                              Obx(
                                                    () => Visibility(
                                                  visible: dashboardController.user_role.value == "super_engineer" ? false : true, child: Container(
