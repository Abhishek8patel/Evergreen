...
//
//     final seHomeReportList = seHomeReportListFromJson(jsonString);

import 'dart:convert';

SeHomeReportList seHomeReportListFromJson(String str) => SeHomeReportList.fromJson(json.decode(str));

String seHomeReportListToJson(SeHomeReportList data) => json.encode(data.toJson());

class SeHomeReportList {
  String id;
  SiteId siteId;
  ...
  factory SeHomeReportList.fromJson(Map<String, dynamic> json) => SeHomeReportList(
    id: json["_id"],
