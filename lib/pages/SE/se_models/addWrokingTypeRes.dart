...
//
//     final addWorkingTypeRes = addWorkingTypeResFromJson(jsonString);

import 'dart:convert';

AddWorkingTypeRes addWorkingTypeResFromJson(String str) => AddWorkingTypeRes.fromJson(json.decode(str));

String addWorkingTypeResToJson(AddWorkingTypeRes data) => json.encode(data.toJson());

class AddWorkingTypeRes {
  String message;
  ...
  factory AddWorkingTypeRes.fromJson(Map<String, dynamic> json) => AddWorkingTypeRes(
    message: json["message"],
    productReport: ProductReport.fromJson(json["product_report"]),
    mainReport: MainReport.fromJson(json["main_report"]),
  );

  Map<String, dynamic> toJson() => {
    "message": message,
    "product_report": productReport.toJson(),
    "main_report": mainReport.toJson(),
  };
}
...
class MainReport {
  ...
  factory MainReport.fromJson(Map<String, dynamic> json) => MainReport(
    userId: json["userId"],
    siteId: json["site_id"],
